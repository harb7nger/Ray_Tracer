...
// tolerance for barycentric coord
#define BTOL 0.001

// max recursions for reflection
#define MAXRECUR 2
...
// dummy color
#define DC {(float)0.0, (float)0.0, (float)0.0}

// default for pair<objID, eta>
#define ETADEF {-1.0, 1.0}

// flag to use schlick's approximation
#define USESHLICKSAPPROX true 
